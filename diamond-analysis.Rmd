...
```{r create-output-folder, warning=FALSE, message=FALSE}
...
```{r autofitting-rpart-tree, warning=FALSE}
...
```{r fitting-simple-rpart-trees, warning=FALSE}
...
```{r saving-off-rpart-data-and-pdfs, warning=FALSE, results='hide'}
