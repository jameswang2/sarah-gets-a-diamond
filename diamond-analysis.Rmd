...
```{r perform-regression-on-full-dataset}
...
```{r perform-stepwise-regression-on-full-dataset}
lm.step <- step(lm, direction = "backward", trace=0, step=10)
...
function and the `mtry` argument set equal to 14 - the number of explanatory 
...
This bagged tree yields a MAPE of 5.34% on the validation set, already a great 
improvement from the 6.4% of the single tuned tree. Given the improvement of the 
...
```{r random-forest-eval, eval=FALSE}
...
```{r boosted-tree-final, eval=FALSE}
